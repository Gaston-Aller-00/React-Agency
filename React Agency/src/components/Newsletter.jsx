...
const Newsletter = () => {
  return (
    <div className="px-4 lg:px-14 max-w-screen-2xl mx-auto bg-neutralSilver py-16 rounded-2xl mb-10" id="testimonial">
      
        <div className="text-center">
          <h2 className="lg:text-5xl text-3xl text-neutralBlack font-semibold mb-6 lg:leading-snug">
          Effortless membership management. Automate renewals and payments seamlessly.
          </h2>
